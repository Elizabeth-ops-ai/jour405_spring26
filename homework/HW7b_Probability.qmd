...
Most salaries are clustered around the mean. The median is really high on the lower end, towards $75,000. It doesn't really look too normally distributed to me.
...
The data seems pretty accurate. On the 1st SD, its lower than expected, but then kinda increases exponentially more than normal. I guess this tells me that even with the rule of distribution, not everything will be 100% accurate.
...
The probabilities are pretty accurate. It's like a 17% difference.
...
This middle range tells us that about 37% of staff fall in the range while 32% actually fall in the middle.
...
It differs the most for those who make between $60k and $90k with a 73% difference. I feel like these are pretty intermediate positions, which makes up most of the white house staff.
...
Headline: How much do White House workers actually make?

New data shows that most White House staff earns a pretty average salary between 60-90k.

I would use probability to list specific roles in the White House that fall in the average category, as well as the roles that are pretty high and low paying. I'd be curious about these roles.
