...
This distribution seems mostly normal. The mean is alligned with the highest amount of danceability. The thing is that it's got a more gradual incline and a rapid drop off.
