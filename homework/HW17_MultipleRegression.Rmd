...
After looking at the data, I think the variables that effect voter turnout are the white population, unemployment, and age. The counties with higher age, less unemployment, and a higher white population are all higher voter turnouts.
...
This model's adjusted r squared shows that there's an 80% chance of it being significant, the coefficients that have the strongest significance are age, income, and percentage of the white population.
...
The percentage white, income, and age are all the best variables.
...
I would use this to see exactly why younger people in Maryland aren't voting. What's making them hesitate? Do they just not care? I think a lot of people would be interested in this.
