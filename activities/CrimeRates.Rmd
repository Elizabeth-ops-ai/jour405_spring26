...
I noticed that the years with the highest crime rates were the early to mid-90s. '93 was the year with the highest crime rate in that decade. The all time lowest year for crime in this chart is 2020. I can understand this data, because the pandemic put everyone on lockdown, and the 90s are notorious for being chaotic.
