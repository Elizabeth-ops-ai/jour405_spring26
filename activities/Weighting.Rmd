...
It goes from 0.22 to 3.303
2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
The respondent with 0.23 is in the range, while 3.04 is out of range.
3. Why might some respondents be weighted more heavily than others?
Because they're closer to the mean, which represents a greater portion of the population.
...
The rarely/never section has the biggest difference with 1.6.

2. How might these differences affect reporting on likely voter turnout?

Because pollsters don't really count them in surveys, making voting outcomes hard to predict.
...
I think these differences exist because pollsters want to be sure they can try to match perdictions to reality the best they can. This tells us that more people tend not to really care about elections in the rarely/never.
