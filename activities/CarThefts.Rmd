...
This distribution isn't exactly normally distributed. I would say it's like 80% normal. The highest value is really close to the mean, but it has a gradual increase and a sharp drop off, which makes this not normal. Most of the data falls within the standard deviaiton.
