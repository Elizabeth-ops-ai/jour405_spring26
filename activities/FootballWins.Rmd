...
This is a useful model because it shows us the right combo of factors that give us a better predicted value. Of all the P-values, points scored are the most significant. We can use it to predict the number of wins, what statistic different teams lacked in that significantly led to their downfalls, etc. Very good model.
...
The combo of Yards gained and points scored have the highest correlation when it comes to winning games. Takeaways don't seem to have any impact on wins.
...
I would use this to cover a team's strategy of what plays worked the best. Is it passing or running the ball? Wide routes, or ones that sneak in between players. I think this would be cool to figure out what teams' specific play weaknesses are, and what plays are the most successful. I would measure yards gained and points scored.
