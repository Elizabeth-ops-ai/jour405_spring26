...
There's a really slight positive correlation with the goal diff and fouls. Overall, the distribution is pretty level though.

### Task 7: Repeat with different variable.
...
```
The correlation between goal diff and corners is far more positive than fouls. 
