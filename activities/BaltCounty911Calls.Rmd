...
From what I've seen in the graph, the months with the highest calls were around October, January, and in spring/early summer. In late July and Feburary, there are significant dips in calls.
...
They don't really differ from my answer on task 3. It does highlight points that are slightly higher than average that I didn't really identify in my previous answer. The graphs help us visualize data that can be hard to distinguish from the norm.
...
We could describe it in percents or probabilities, like "there's a one in ___ chance."
...
I would look at the high points of OD calls with the bad batches of drugs with fent in them. I would try and see if each batch had similar chemical makeups for what caused the overdoses.
